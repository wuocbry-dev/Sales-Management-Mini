      ...
      <Card>
        ...
        <CardContent className="grid gap-4 sm:grid-cols-4">
          <div className="space-y-2">
            <Label>Kho nguồn (mã)</Label>
            <Input value={dFrom} onChange={(e) => setDFrom(e.target.value)} inputMode="numeric" placeholder="Tuỳ chọn" />
          </div>
          <div className="space-y-2">
            <Label>Kho đích (mã)</Label>
            <Input value={dTo} onChange={(e) => setDTo(e.target.value)} inputMode="numeric" placeholder="Tuỳ chọn" />
          </div>
          <div className="space-y-2">
                ...
                {data.content.length === 0 ? (
                  ...
                  data.content.map((row) => (
                    <TableRow key={row.id}>
                      ...
                      <TableCell className="tabular-nums">{row.fromWarehouseId}</TableCell>
                      <TableCell className="tabular-nums">{row.toWarehouseId}</TableCell>
                      <TableCell>
