...
const appChildren: RouteObject[] = [
  ...
  guarded("cua-hang", <StoreListPage />, { title: "Cửa hàng", subtitle: "Danh sách cửa hàng được phân quyền xem." }, gateStoreDataRead),
  guarded("cua-hang/:storeId", <StoreDetailPage />, { title: "Chi tiết cửa hàng" }, gateStoreDataRead),
  guarded("cua-hang/:storeId/nguoi-dung", <StoreScopedUsersPage />, { title: "Người dùng trong cửa hàng" }, gateStoreScopedUserView),
  guarded("cua-hang/:storeId/chi-nhanh/:branchId", <BranchDetailPage />, { title: "Chi tiết chi nhánh" }, gateBranchView),
  guarded("cua-hang/:storeId/chi-nhanh", <BranchListPage />, { title: "Chi nhánh" }, gateBranchView),
  guarded("cua-hang/:storeId/kho/:warehouseId", <WarehouseDetailPage />, { title: "Chi tiết kho" }, gateInventoryView),
  guarded("cua-hang/:storeId/kho", <WarehouseListPage />, { title: "Kho hàng" }, gateInventoryView),
  guarded("chi-nhanh", <BranchHubPage />, { title: "Chi nhánh", subtitle: "Điều hướng tới cửa hàng để quản lý chi nhánh." }, gateBranchView),
  guarded("kho", <WarehouseHubPage />, { title: "Kho hàng", subtitle: "Điều hướng tới cửa hàng để xem kho." }, gateInventoryView),
  guarded("thuong-hieu", <BrandListPage />, { title: "Thương hiệu", subtitle: "Danh mục thương hiệu hàng hóa." }, gateMasterCatalog),
  guarded("thuong-hieu/:id", <BrandDetailPage />, { title: "Chi tiết thương hiệu" }, gateMasterCatalog),
  guarded("nhom-hang", <CategoryListPage />, { title: "Nhóm hàng", subtitle: "Danh mục nhóm hàng." }, gateMasterCatalog),
  guarded("nhom-hang/:id", <CategoryDetailPage />, { title: "Chi tiết nhóm hàng" }, gateMasterCatalog),
  guarded("don-vi", <UnitListPage />, { title: "Đơn vị tính", subtitle: "Đơn vị quy đổi hàng hóa." }, gateMasterCatalog),
  guarded("don-vi/:id", <UnitDetailPage />, { title: "Chi tiết đơn vị tính" }, gateMasterCatalog),
  guarded("nha-cung-cap", <SupplierListPage />, { title: "Nhà cung cấp", subtitle: "Đối tác cung ứng." }, gateMasterCatalog),
  guarded("nha-cung-cap/:id", <SupplierDetailPage />, { title: "Chi tiết nhà cung cấp" }, gateMasterCatalog),
  ...
  guarded("phan-quyen", <RbacHubPage />, { title: "Phân quyền", subtitle: "Vai trò, quyền và ghi đè." }, gateRbacArea),
