...
const appChildren: RouteObject[] = [
  ...
  { path: "inventory/transactions", element: <Navigate to="/app/bien-dong-kho" replace /> },
  ...
  guarded(
    "bien-dong-kho",
    <InventoryOverviewPage initialTab="transactions" />,
    { title: "Biến động kho", subtitle: "Lịch sử xuất nhập và điều chỉnh tồn." },
    gateInventoryTransactionView,
  ),
